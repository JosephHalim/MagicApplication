					...
					ref global::Interop_mincore_COPYFILE2_EXTENDED_PARAMETERS__System_IO_FileSystem pExtendedParameters)
		{
			...
			fixed (char* pinned_pwszExistingFileName = pwszExistingFileName)
			{
				...
				fixed (char* pinned_pwszNewFileName = pwszNewFileName)
				{
					...
					// Call to native method
					unsafe___value = global::__Interop.api_ms_win_core_file_l2_1_1_dll_PInvokes.CopyFile2(
	...
	public unsafe static partial class api_ms_win_core_file_l1_2_1_dll
	{
					...
					int attr)
		{
			...
			fixed (char* pinned_name = name)
			{
				unsafe_name = (ushort*)pinned_name;
				// Call to native method
				unsafe___value = global::__Interop.api_ms_win_core_file_l1_2_1_dll_PInvokes.SetFileAttributesPrivate(
									unsafe_name, 
									attr
								);
				global::System.Runtime.InteropServices.DebugAnnotations.PreviousCallContainsUserCode();
					...
					uint dwBufferSize)
		{
			...
			unsafe_lpFileInformation = lpFileInformation;
			// Call to native method
			unsafe___value = global::__Interop.api_ms_win_core_file_l1_2_1_dll_PInvokes.SetFileInformationByHandle(
								hFile.DangerousGetHandle(), 
								FileInformationClass, 
								&(unsafe_lpFileInformation), 
								dwBufferSize
